...
[![CI](https://github.com/PlatformStackPulse/tf-atom-ssm-parameter-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-ssm-parameter-aws/actions/workflows/ci.yml)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-ssm-parameter-aws)](https://github.com/PlatformStackPulse/tf-atom-ssm-parameter-aws/releases)
...
Terraform atom: AWS SSM Parameter - creates a Parameter Store parameter (String/SecureString)
...
|------|-------------|------|---------|:--------:|
| <a name="input_parameter_name"></a> [parameter\_name](#input\_parameter\_name) | Name suffix for the SSM parameter (prepended with module ID path) | `string` | n/a | yes |
...
| <a name="input_tier"></a> [tier](#input\_tier) | Tier of the SSM parameter (Standard, Advanced, Intelligent-Tiering) | `string` | `"Standard"` | no |
| <a name="input_type"></a> [type](#input\_type) | Type of the SSM parameter (String, StringList, SecureString) | `string` | `"SecureString"` | no |
...
| <a name="output_parameter_arn"></a> [parameter\_arn](#output\_parameter\_arn) | ARN of the SSM parameter |
| <a name="output_parameter_name"></a> [parameter\_name](#output\_parameter\_name) | Name of the SSM parameter |
| <a name="output_parameter_version"></a> [parameter\_version](#output\_parameter\_version) | Version of the SSM parameter |
<!-- END_TF_DOCS -->
