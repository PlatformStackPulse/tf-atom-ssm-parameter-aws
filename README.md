...
| <a name="input_data_type"></a> [data\_type](#input\_data\_type) | Data type of the parameter (e.g. text, aws:ec2:image, aws:ssm:integration). | `string` | `null` | no |
...
| <a name="input_key_id"></a> [key\_id](#input\_key\_id) | KMS key id/alias/ARN used to encrypt a SecureString parameter. Ignored for non-SecureString types. | `string` | `null` | no |
...
| <a name="input_parameter_name"></a> [parameter\_name](#input\_parameter\_name) | Name (path) of the SSM parameter. Defaults to the tf-label id (module.this.id) when null. | `string` | `null` | no |
...
| <a name="input_tier"></a> [tier](#input\_tier) | Parameter tier. One of Standard, Advanced, or Intelligent-Tiering. | `string` | `"Standard"` | no |
| <a name="input_type"></a> [type](#input\_type) | Type of the parameter. One of String, StringList, or SecureString. | `string` | `"String"` | no |
| <a name="input_value"></a> [value](#input\_value) | Value of the SSM parameter. Required when the module is enabled. | `string` | `null` | no |

### Outputs

| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | The ARN of the SSM parameter. |
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Whether the module is enabled. |
| <a name="output_id"></a> [id](#output\_id) | The name (id) of the SSM parameter. |
| <a name="output_name"></a> [name](#output\_name) | The name (path) of the SSM parameter. |
| <a name="output_version"></a> [version](#output\_version) | The version of the SSM parameter. |
<!-- END_TF_DOCS -->
